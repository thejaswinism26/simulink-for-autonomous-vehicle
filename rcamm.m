...
m = 10; %Aircraft total mass (kg)
%NOTE: We will define Ib and invib later

cbar = 0.3048; %Mean Aerodynamic Chord (m)
lt = 24.8;  %Distance by AC of tail and body (m)
S = 1.114;    %Wing planform area (m^2)
...
Yapt1 = 0;  %y position of engine 1 force in Em (m)
Zapt1 = 0;   %z position of engine 1 force in Em (m)

Xapt2 = 0;      %x position of engine 1 force in Em (m)
Yapt2 = 0;  %y position of engine 1 force in Em (m)
Zapt2 = 0;  
%other constants
